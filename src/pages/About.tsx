    ...
    <section className="section" style={{ paddingTop: 'calc(var(--nav-height) + var(--space-16))' }}>
      <div className="container">
        <div className="reveal">
          ...
          <h1 className="section-title" style={{ fontSize: 'var(--text-5xl)', lineHeight: 1.15, textWrap: 'balance' }}>
            Engineering <span className="text-gradient">intelligent</span> ML solutions.
          </h1>
        </div>

        <div className="about-grid" style={{ marginTop: 'var(--space-16)' }}>
          ...
          <div>
            <div className="about-stats reveal reveal-delay-1">
              <div className="about-stat">
                <div className="about-stat-value text-gradient">4</div>
                <div className="about-stat-label">Shipped Products</div>
              </div>
              <div className="about-stat">
                <div className="about-stat-value text-gradient">38+</div>
                <div className="about-stat-label">Releases</div>
              </div>
              <div className="about-stat">
                <div className="about-stat-value text-gradient">19+</div>
                <div className="about-stat-label">ML Metrics</div>
              </div>
              <div className="about-stat">
                <div className="about-stat-value text-gradient">6</div>
                <div className="about-stat-label">AI Agents</div>
              </div>
            </div>

            <div className="skills-grid reveal reveal-delay-2" style={{ marginTop: 'var(--space-8)' }}>
              {skillCategories.map(cat => (
                <div key={cat.name} className="skill-category">
                  <h3>{cat.name}</h3>
                  <div className="skill-category-items">
                    {cat.items.map(s => <span key={s} className="badge">{s}</span>)}
                  </div>
                </div>
              ))}
            </div>
